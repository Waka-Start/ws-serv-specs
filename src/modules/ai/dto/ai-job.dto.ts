...
export class AiJobResponseDto {
  ...
  @ApiPropertyOptional({
    description:
      "Progression du job (RUNNING uniquement). Pour VENTILATE_SUBCHAPTERS : { currentStep, totalSteps, phase, currentSubChapterTitle }",
  })
  ...
  @ApiPropertyOptional({
    description: "Code erreur classifie (FAILED uniquement)",
  })
